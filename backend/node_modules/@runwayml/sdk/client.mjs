...
import { SoundEffect } from "./resources/sound-effect.mjs";
import { SpeechToSpeech, } from "./resources/speech-to-speech.mjs";
...
import { TextToVideo } from "./resources/text-to-video.mjs";
import { VideoToVideo, } from "./resources/video-to-video.mjs";
import { VideoUpscale, } from "./resources/video-upscale.mjs";
import { VoiceDubbing, } from "./resources/voice-dubbing.mjs";
import { VoiceIsolation, } from "./resources/voice-isolation.mjs";
...
export class RunwayML {
     ...
     */
    constructor({ baseURL = readEnv('RUNWAYML_BASE_URL'), apiKey = readEnv('RUNWAYML_API_SECRET'), runwayVersion = '2024-11-06', ...opts } = {}) {
        ...
        __classPrivateFieldSet(this, _RunwayML_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!__classPrivateFieldGet(this, _RunwayML_instances, "m", _RunwayML_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return __classPrivateFieldGet(this, _RunwayML_encoder, "f").call(this, { body, headers });
        }
    }
}
