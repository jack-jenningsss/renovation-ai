...
export declare namespace OrganizationRetrieveResponse {
    ...
    namespace Tier {
        ...
        namespace Models {
             ...
             * Limits associated with the eleven_multilingual_sts_v2 model.
             */
            interface ElevenMultilingualStsV2 {
                /**
                 * The maximum number of generations that can be run concurrently for this model.
                 */
                maxConcurrentGenerations: number;
             ...
             * Limits associated with the eleven_multilingual_v2 model.
             */
            interface ElevenMultilingualV2 {
                /**
                 * The maximum number of generations that can be run concurrently for this model.
                 */
                maxConcurrentGenerations: number;
             ...
             * Limits associated with the eleven_voice_isolation model.
             */
            interface ElevenVoiceIsolation {
                /**
                 * The maximum number of generations that can be run concurrently for this model.
                 */
                maxConcurrentGenerations: number;
...
export interface OrganizationRetrieveUsageResponse {
     ...
     */
    models: Array<'act_two' | 'eleven_multilingual_sts_v2' | 'eleven_multilingual_v2' | 'eleven_text_to_sound_v2' | 'eleven_voice_dubbing' | 'eleven_voice_isolation' | 'gemini_2.5_flash' | 'gen3a_turbo' | 'gen4_aleph' | 'gen4_image' | 'gen4_image_turbo' | 'gen4_turbo' | 'upscale_v1' | 'veo3' | 'veo3.1' | 'veo3.1_fast'>;
...
export declare namespace OrganizationRetrieveUsageResponse {
    ...
    namespace Result {
        interface UsedCredit {
             ...
             */
            model: 'act_two' | 'eleven_multilingual_sts_v2' | 'eleven_multilingual_v2' | 'eleven_text_to_sound_v2' | 'eleven_voice_dubbing' | 'eleven_voice_isolation' | 'gemini_2.5_flash' | 'gen3a_turbo' | 'gen4_aleph' | 'gen4_image' | 'gen4_image_turbo' | 'gen4_turbo' | 'upscale_v1' | 'veo3' | 'veo3.1' | 'veo3.1_fast';
        }
    }
}
