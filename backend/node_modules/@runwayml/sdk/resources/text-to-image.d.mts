...
import { APIPromiseWithAwaitableTask } from "../lib/polling.mjs";
export declare class TextToImage extends APIResource {
    /**
     * This endpoint will start a new task to generate images from text and/or image(s)
     */
    create(body: TextToImageCreateParams, options?: RequestOptions): APIPromiseWithAwaitableTask<TextToImageCreateResponse>;
}
...
export interface TextToImageCreateParams {
     ...
     * - `1152x896`
     */
    ratio: '1920:1080' | '1080:1920' | '1024:1024' | '1360:768' | '1080:1080' | '1168:880' | '1440:1080' | '1080:1440' | '1808:768' | '2112:912' | '1280:720' | '720:1280' | '720:720' | '960:720' | '720:960' | '1680:720' | '1344:768' | '768:1344' | '1184:864' | '864:1184' | '1536:672' | '832x1248' | '1248x832' | '896x1152' | '1152x896';
    /**
...
export declare namespace TextToImage {
    export { type TextToImageCreateResponse as TextToImageCreateResponse, type TextToImageCreateParams as TextToImageCreateParams, };
}
