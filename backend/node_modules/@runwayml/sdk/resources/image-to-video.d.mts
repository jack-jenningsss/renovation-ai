...
export declare class ImageToVideo extends APIResource {
    /**
     * This endpoint will start a new task to generate a video from an image prompt.
     */
    create(body: ImageToVideoCreateParams, options?: RequestOptions): APIPromiseWithAwaitableTask<ImageToVideoCreateResponse>;
}
...
export interface ImageToVideoCreateParams {
     ...
     * - `1920:1080`
     */
    ratio: '1280:720' | '720:1280' | '1104:832' | '832:1104' | '960:960' | '1584:672' | '1280:768' | '768:1280' | '1080:1920' | '1920:1080';
    /**
...
export declare namespace ImageToVideo {
    export { type ImageToVideoCreateResponse as ImageToVideoCreateResponse, type ImageToVideoCreateParams as ImageToVideoCreateParams, };
}
//# sourceMappingURL=image-to-video.d.mts.map